...
using System.Linq;
using Unity.Netcode;
public class EnemyAttackManager : NetworkBehaviour
{
    ...
    public override void OnNetworkSpawn(){ //just in case the copy overrider hasn't been assigned yet in EnemyAI3.Awake()
