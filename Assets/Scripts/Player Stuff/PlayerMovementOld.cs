...
//     [SerializeField] private SkinnedMeshRenderer playerBodyRenderer;
...
//         if (IsOwner)
//         {
//             _playerStats.OnStatsConfigured += () => statsConfigured = true;
//             Initialize();
//         }
//         else
//         {
...
//             {
//                 bool isFirstPerson = currentCameraDistance < firstPersonThreshold;
//                 playerBodyRenderer.enabled = !isFirstPerson;
//             }
//         }
//     }
